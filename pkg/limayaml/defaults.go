...
func defaultContainerdArchives() []File {
	const nerdctlVersion = "2.0.0-beta.2"
	...
	return []File{
		{
			...
			Arch:     X8664,
			Digest:   "sha256:38b70607cac90d0eb8e080cd2eb38c8ea917b6424034a865699b3d64f694f12e",
		},
		{
			Location: location("linux", "arm64"),
			Arch:     AARCH64,
			Digest:   "sha256:97d95349cf571b5c83459f32a952479cad2c766d207ba7c20de39b8a8e78f172",
		},
		// No arm-v7
		// No riscv64
	}
